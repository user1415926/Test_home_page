 ...
 * Description: Shortcode for managing eight audio tracks with waveform regions and playback scripting.
 * Version: 1.0.0
 * Author: GPT-5 Codex
...
final class Audio_Waveform_Visualizer {
        ...
        wp_localize_script(
            ...
            [
                'strings' => [
                    ...
                    'commandPanelHelp'      => __('Select a region on any track, then add a command with start time and playback speed.', 'audio-waveform-visualizer'),
    ...
    /**
     * Enqueues assets for the shortcode output.
     */
