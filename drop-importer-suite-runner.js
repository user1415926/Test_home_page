...
jQuery(function ($) {
    ...
    const formCSV = $('input[name="dropi_csv"]').val();
    ...
    function runNext() {
        ...
        const csv = $('input[name="dropi_csv"]').val() || '';

        logLine('Request offset=' + offset + ' limit=' + limit + ' dry=' + dry + ' skip=' + skip + ' debug=' + debug);
